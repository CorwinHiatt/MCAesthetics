...
export default function Footer() {
  return (
    // Main wrapper with distinctive border
    <div className="border-8 border-indigo-500 mt-16" style={{ borderWidth: '12px' }}>
      <footer className="bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Company Info */}
            <div>
              <h3 className="text-lg font-semibold mb-4">MC Aesthetics</h3>
              <p className="text-gray-600 mb-4">
                Providing premium aesthetic services since 2010.
              </p>
            ...
            <div>
              ...
              <address className="not-italic text-gray-600">
                ...
                <p>
                  <a href="mailto:info@mcaesthetics.com" className="hover:text-primary">
                    info@mcaesthetics.com
                  </a>
                </p>
              </address>
            </div>
            ...
            <div>
              ...
              <form className="flex">
                <input 
                  ...
                  className="px-4 py-2 w-full rounded-l-md border-gray-300 focus:ring-primary focus:border-primary"
                />
                <button 
                  type="submit" 
          ...
          <div className="border-t border-gray-200 mt-12 pt-8 text-center text-gray-500">
            <p>© {new Date().getFullYear()} MC Aesthetics. All rights reserved.</p>
