    ...
    if (form.current) {
      ...
      try {
        const token = await window.grecaptcha.execute(
          '6LcvfMErAAAAAI3zzfntZawJciDSdzwhXcmSqvlL',
          { action: 'submit' }
        );
        ...
        if (!response.ok) {
          ...
          if (errorData.error.includes('reCAPTCHA')) {
            throw new Error(
              'Verification failed—looks like something went wrong. Please try submitting again.'
            );
          } else {
    ...
    <div className={styles.mcaContactPageWrapper}>
      <Script
        ...
        onError={() => {
          ...
          setStatus(
            'Failed to load verification system. Check your network and try again.'
          );
        }}
      />
      ...
      <div className={styles.mcaContactHero}>
        ...
        <p className={styles.mcaContactTagline}>
        ...
        <p className={styles.mcaContactIntroText}>
          ...
          free to reach out. Fill out the form below, and we&apos;ll get back to
      ...
      <div className={styles.mcaContactContentSection}>
        <h2 className={styles.mcaContactSectionTitle}>
        ...
        <div className={styles.mcaContactInfoGrid}>
          ...
          <div className={styles.mcaContactInfoCard}>
            ...
            <p className={styles.mcaContactInfoText}>
              <a href="tel:971-267-2322" className={styles.mcaContactInfoLink}>
                971-267-2322
              </a>
            </p>
          </div>
          ...
          <div className={styles.mcaContactInfoCard}>
            ...
            <p className={styles.mcaContactInfoText}>
              <a
                href="mailto:admin@mcaestheticsclinic.com"
                className={styles.mcaContactInfoLink}
              >
        ...
        <p className={styles.mcaContactInfoSubtext}>
          Reach out to us directly using the details above, or use the form to
          send a message. We&apos;re excited to connect with you!
        </p>
      </div>

      {/* Call to Action */}
      <div className={styles.mcaContactCallToAction}>
        <h2 className={styles.mcaContactCtaTitle}>
          Ready to Transform Your Look?
        </h2>
        <p className={styles.mcaContactCtaSubtext}>
          Book your consultation today and discover the MC Aesthetics
          difference.
        </p>
        <PrimaryButton
